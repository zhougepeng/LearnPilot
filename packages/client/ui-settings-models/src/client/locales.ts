...
export const en = {
  nav: 'Models',
  title: 'Models',
  intro: 'Configure model providers, then choose the default used across DSH.',
  defaultTitle: 'Default model',
  defaultDescription: 'New conversations and homework organization use this model unless a session chooses another.',
  defaultSelect: 'Default model',
  defaultUnavailable: 'Current default unavailable: {model}',
...
export const zh: { [Key in keyof typeof en]: string } = {
  nav: '模型',
  title: '模型',
  intro: '配置模型提供方，并选择 DSH 全局使用的默认模型。',
  defaultTitle: '默认模型',
  defaultDescription: '新会话和作业整理默认使用这个模型；已有会话仍可单独选择。',
  defaultSelect: '默认模型',
  defaultUnavailable: '当前默认模型不可用：{model}',
  setDefault: '设为默认',
  savingDefault: '保存中…',
