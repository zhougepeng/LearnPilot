...
import homeworkRemote from '@deepseek-ai/dsh-education-homework-controller/remote'
...
export type {} from '@deepseek-ai/dsh-education-homework-controller/remote'
export type * from '@deepseek-ai/dsh-education-homework-controller/types'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      ...
      subagentsRemote, sessionRemote, workspaceRemote, homeworkRemote,
    ]) {
